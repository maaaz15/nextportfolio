const Footer = () => {
    return (
        <main className="container my-8 flex space-y-2 items-center flex-col justify-center dark:text-slate-200">
            <div className="flex items-center space-x-8 my-2">
                ...
                >
                    ...
                    <svg
                        ...
                        viewBox="0 0 16 16"
                        fill="currentColor"
                        className="h-6 w-6 dark:text-slate-400 dark:hover:text-slate-200 text-gray-500 hover:text-black duration-200"
                        aria-hidden="true"
                    >
                ...
                >
                    ...
                    <svg
                        ...
                        fill="none"
                        className="h-5 w-5 dark:text-slate-400 dark:hover:text-slate-200 text-gray-500 hover:text-black duration-200"
                        aria-hidden="true"
                    >
                        <path
            ...
            <div className="flex items-center space-x-2 justify-center text-base">
                {/* <span>Copyright</span> */}
                <span>©</span>
